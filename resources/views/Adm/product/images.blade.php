...
@section('head')
    {!! Html::style("assets/dropzone/dropzone.min.css") !!}
@stop
...
@section('footer')
    ...
    <script type="text/javascript">
        ...
        var url = '{!! url("adm/products/images/".$id) !!}';
        dropzoneJs(url, _token);
    </script>
@stop
...
<div class="row">
        <div class="col-md-offset-1 col-md-10">
            <div class="jumbotron how-to-create" >
                ...
                {!! Form::open(['url' => ('adm/products/images/'.$id), 'class' => 'dropzone', 'files'=>true, 'id'=>'real-dropzone']) !!}
